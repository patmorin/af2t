...
\begin{proof}
    ...
    \begin{compactenum}
        ...
        \item For each $i\in\{1,\ldots,2r\}\setminus\bigcup_{a\in\Sigma}(I_a\cup Y_a)$, $P$ contains the top row of $H_i$.
    \end{compactenum}
