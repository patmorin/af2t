...
\dateline{May 5, 2021}{Apr 27, 2020}{TBD}
\MSC{05C15}
\Copyright{The authors. Released under the CC BY license (International 4.0).}


\title{$2\times n$ grids have unbounded anagram-free \\ chromatic number\thanks{This research was partly funded by NSERC.}}
\author{%
  Saman Bazargani\\
  ...
  \small\tt saman.bazargani@gmail.com
  \and
  Paz Carmi\\
  \small Department of Computer Science\\[-0.8ex]
  \small Ben-Gurion University of the Negev\\[-0.8ex]
  \small Beer-Sheva, Israel\\
  \small\tt carmip@cs.bgu.ac.il
  \and Vida Dujmović\\
  \small Department of Computer Science and Electrical Engineering\\[-0.8ex]
  \small University of Ottawa\\[-0.8ex]
  \small Ontario, Canada\\
...
% \begin{titlepage}
\maketitle
\vspace{-2ex} % Avoids putting subject classification on second page!
\begin{abstract}
    We show that anagram-free vertex colouring a $2\times n$ square grid requires a number of colours that increases with $n$.  This answers an open question in Wilson's thesis and shows that that are even graphs of pathwidth $2$ that do not have anagram-free colourings with a bounded number of colours.
\end{abstract}
